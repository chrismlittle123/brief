...
V4 builds on the [V3 spec](./v3.md) with a Slack app integration that brings check-in reminders, one-tap voice sessions, and report delivery directly into Slack.
...
This is noted as a future enhancement — V4 ships with individual report delivery.
...
| Route | Notes |
|-------|-------|
| All V3 session routes | Unchanged |
...
Existing pages (V1–V3) remain as alternative input methods.
...
| All V3 variables | Unchanged | - |

## Updated User Flow

**Slack-initiated (primary V4 flow):**
